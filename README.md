...
1. Azure CLI download  
https://learn.microsoft.com/en-us/cli/azure/install-azure-cli?spm=5aebb161.2ef5001f.0.0.14b0c921o507pb  

2. choose Install on Windows using Microsoft Installer (MSI)
